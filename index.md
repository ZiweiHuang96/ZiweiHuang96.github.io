...
12. Lu BAI, Mingran SUN, **Ziwei Huang\***, Tao FENG, Xiang CHENG. A multi-UAV cooperative channel model for emergency communication scenarios (Invited Paper)[J]. Journal on Communications, 2023, 44(7): 38-50. (EI, CCF-T1).
...
### Conference Papers
1. **Ziwei Huang\*** *et al.*, "[A space-time non-stationary and consistent model for 6G multi-UAV cooperative channels](https://ieeexplore.ieee.org/abstract/document/10233586),'' in *Proc. IEEE/CIC International Conference on Communications in China (ICCC)*, Dalian, China, Aug. 2023, accpeted. (EI)
